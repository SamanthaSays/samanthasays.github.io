...
<dl id="changelog" style="display: none">
    <dt>9 Apr 2026</dt>
        ...
        <dd>- Added At Hell's Gate.</dd>
        <dd>- Added Auto Unlock.</dd>
        <dd>- Added Blackout Big Bang Skin.</dd>
        <dd>- Added Blackout Grendel Skin.</dd>
        <dd>- Added Blackout Hard Target Skin.</dd>
        <dd>- Added Blackout Kodama Skin.</dd>
        <dd>- Added Cash In CredStiks.</dd>
        <dd>- Added Choose Your Variant Universe.</dd>
        <dd>- Added Civilian Survival Suit.</dd>
        <dd>- Added Climate Change.</dd>
        <dd>- Added Creature Plushie Set.</dd>
        <dd>- Added Crowd Gun Fear.</dd>
        <dd>- Added Deimog.</dd>
        <dd>- Added Dynamic Medical Bill.</dd>
        <dd>- Added Dynamic Repair Bill.</dd>
        <dd>- Added Enhanced Lights and FX.</dd>
        <dd>- Added Escape.</dd>
        <dd>- Added First Person Running with Hands.</dd>
        <dd>- Added Functional Reflex Sights.</dd>
        <dd>- Added Galactic Mesh Fixes.</dd>
        <dd>- Added Geotag Photos.</dd>
        <dd>- Added Immersive Driving.</dd>
        <dd>- Added No Vehicle Mouse Steering.</dd>
        <dd>- Added Parked Vehicles.</dd>
        <dd>- Added Rabbit's Real Lights Akila City.</dd>
        <dd>- Added Rabbit's Real Lights Asteroid Mansion.</dd>
        <dd>- Added Rabbit's Real Lights Cydonia.</dd>
        <dd>- Added Rabbit's Real Lights Dazra.</dd>
        <dd>- Added Rabbit's Real Lights Eleos Retreat.</dd>
        <dd>- Added Rabbit's Real Lights Gagarin.</dd>
        <dd>- Added Rabbit's Real Lights HopeTown.</dd>
        <dd>- Added Rabbit's Real Lights Landing Pads.</dd>
        <dd>- Added Rabbit's Real Lights Neon.</dd>
        <dd>- Added Rabbit's Real Lights New Atlantis.</dd>
        <dd>- Added Rabbit's Real Lights New Homestead.</dd>
        <dd>- Added Rabbit's Real Lights Paradiso.</dd>
        <dd>- Added Scopes Without Overlays.</dd>
        <dd>- Added Sensible Outpost Lighting.</dd>
        <dd>- Added Shattered Space Plushie Set.</dd>
        <dd>- Added Smooth UI.</dd>
        <dd>- Added The Perfect Recipe.</dd>
        <dd>- Added Trackers Alliance: The Complete Bounty Series.</dd>
        <dd>- Added Wall Snap Letters Numbers and Symbols.</dd>
        <dd>- Removed CharGenMenu.</dd>
        <dd>- Removed Discord Rich Presence.</dd>
        <dd>- Removed Enemy Friendly Fire.</dd>
        <dd>- Removed High-Vis Scope Crosshair Replacement.</dd>
        <dd>- Removed Landing Animation Reloaded.</dd>
        <dd>- Removed Smooth Interface.</dd>
        <dd>- Removed Starfield Community Patch.</dd>
        <dd>- Removed StarUI Inventory.</dd>
        <dd>- Removed StarUI Outpost.</dd>
        <dd>- Removed StarUI Ship Builder.</dd>
        <dd>- Removed StarUI Workbench.</dd>
        <dd>- Removed Trackers Alliance: The Vulture.</dd>
    <dt>17 Aug 2024</dt>
